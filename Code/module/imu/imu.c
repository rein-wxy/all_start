...
ACCEL_t ACCEL;
int16_t TEMP;
float imu_pid[3] = {1400,0.2,0};

void imu_sensor_init(void)
{
	BMI_Init();
	PID_init(&pid_imu_temp,0,&imu_pid[0],1600,4500);
...
{
	PID_calc(&pid_imu_temp,imu.temperature,40.0f);
	TIM10->CCR1 = pid_imu_temp.out;
}
